...
class LINEAR_FEEDBACK_CONTROLLER_PUBLIC RobotModelBuilder {
    public:
        ...
        /**
         * @brief Get Pinocchio joint space dimension (position) including free-flyer joint.
         */
        virtual int get_nq() const;
        /**
         * @brief Get Pinocchio joint space dimension (velocity) including free-flyer joint.
         */
        virtual int get_nv() const;
        /**
         * @brief Get Pinocchio joint space dimension (position) excluding free-flyer joint.
         * In case of a continuous joint, it will add 2 to nq (cos, sin)
         */
        virtual int get_joint_configuration_nq() const;
        /**
         * @brief Get Hardware joint space dimension (position) excluding free-flyer joint.
         * In case of a continuous joint, it will add only 1 to nq
         */
        virtual int get_joint_position_nq() const;
        /**
         * @brief Get Pinocchio joint space dimension (velocity) excluding free-flyer joint.
         */
        ...
        /**
         * @brief Convert joint positions vector (used by the hardware interface) to joint configuration vector (used by Pinocchio).
         *
         * @return Eigen::VectorXd
         */
