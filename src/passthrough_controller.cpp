...
controller_interface::CallbackReturn PassthroughController::on_init()
{
  try
  {
    param_listener_ = std::make_shared<passthrough_controller::ParamListener>(get_node());
...
PLUGINLIB_EXPORT_CLASS(
  linear_feedback_controller::PassthroughController, controller_interface::ChainableControllerInterface)