...
{
  setParameters(end_time, 0.0 /*start_pos*/, 0.0 /*start_speed*/, 0.0 /*start_acc*/,
                end_pos, 0.0 /*end_speed*/, 0.0 /*end_acc*/);
}

void MinJerk::setParameters(double end_time, double start_pos, double start_speed,
                            double start_acc, double end_pos, double end_speed, double end_acc)
{
  ...
  {
    coeffs_[3] = -(1.5 * start_acc_ * end_time_ * end_time_ -
                   0.5 * end_acc_ * end_time_ * end_time_ + 6.0 * start_speed * end_time_ +
                   4.0 * end_speed_ * end_time_ + 10.0 * start_pos_ - 10.0 * end_pos_) /
                 tmp;
    tmp = tmp * end_time_;
    coeffs_[4] = (1.5 * start_acc_ * end_time_ * end_time_ -
                  end_acc_ * end_time_ * end_time_ + 8.0 * start_speed * end_time_ +
                  7.0 * end_speed_ * end_time_ + 15.0 * start_pos_ - 15.0 * end_pos_) /
                 tmp;
    tmp = tmp * end_time_;
    coeffs_[5] = -(0.5 * start_acc_ * end_time_ * end_time_ -
                   0.5 * end_acc_ * end_time_ * end_time_ + 3.0 * start_speed * end_time_ +
                   3.0 * end_speed_ * end_time_ + 6.0 * start_pos_ - 6.0 * end_pos_) /
                 tmp;
  }
}
